...
class S3DIS:
    def __init__(self, test_area_idx):
        self.name = 'S3DIS'
        self.path = '/media/wjh/SATA/RandLA-Net-master/data/S3DIS'
...
if __name__ == '__main__':
    ...
    if Mode == 'train':
        ...
        num_params = dataset.count_model_params(model)
        print('Total number of parameters: {}'.format(num_params))
        options = tf.profiler.ProfileOptionBuilder.float_operation()
        flops = tf.profiler.profile(tf.get_default_graph(), options=options)
